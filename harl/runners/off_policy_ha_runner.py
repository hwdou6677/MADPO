        ...
        if self.total_it % self.policy_freq == 0:
            ...
            if self.args["algo"] == "hasac":
                ...
                for agent_id in agent_order:
                    ...
                    exploration = -self.alpha[agent_id] * logp_action
