...
class OnPolicyBase:
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        self.old_actor = StochasticPolicy(args, self.obs_space, self.act_space, self.device)
        ...
        self.old_actor_optimizer = torch.optim.Adam(
            self.old_actor.parameters(),
            lr=self.lr,
            eps=self.opti_eps,
            weight_decay=self.weight_decay,
        )
    ...
    @staticmethod
    def evaluate_actions_with_input_actor(
            obs,
            rnn_states_actor,
            action,
            masks,
